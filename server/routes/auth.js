...
const { signupStep1, signupStep2, signupComplete, loginUser, getMe, requestOTP, updatePasswordWithOTP, forgotPassword, resetPasswordPublic } = require('../controllers/authController');
